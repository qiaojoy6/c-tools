          ...
          return (
            (e.prototype._textSpanToRange = function (e, t) {
              var n = e.getPositionAt(t.start),
                ...
                s = r.lineNumber,
                a = r.column;
              return { startLineNumber: i, startColumn: o, endLineNumber: s, endColumn: a };
            }),
            e
          );
        })(),
            ...
            (e.prototype.getOrCreateModel = function (e) {
              ...
              return (
                ...
                (this.isLibFile(e) && this._hasFetchedLibFiles
                  ? i.O0.createModel(this._libFiles[e.path.slice(1)], "typescript", e)
                  : null)
              );
            }),
                ...
                if (e.getModeId() === r) {
                  var t,
                    n = function () {
                      ...
                      t ? e.isAttachedToEditor() && s._doValidate(e) : s._doValidate(e);
                    },
                    ...
                    a = e.onDidChangeAttached(function () {
                      var t = s._defaults.getDiagnosticsOptions().onlyVisible;
                      t && (e.isAttachedToEditor() ? n() : i.O0.setModelMarkers(e, s._selector, []));
                    });
                      ...
                      return (
                        ...
                        e.isDisposed()
                          ...
                          : ((n = []),
                            ...
                            s || n.push(t.getSemanticDiagnostics(e.uri.toString())),
                        ...
                        !u || e.isDisposed()
                          ...
                          : ((l = u
                              ...
                              .filter(function (e) {
                                return (
                                  -1 ===
                                  (p._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(e.code)
                                );
                              })),
                            (c = l
                              .map(function (e) {
                              ...
                              .map(function (e) {
                                return e.file ? i.SK.parse(e.file.fileName) : null;
                              })),
                  ...
                  switch (d.label) {
                    case 0:
                      return (
                        ...
                        (o = new i.EH(n.lineNumber, r.startColumn, n.lineNumber, r.endColumn)),
                        (s = e.uri),
                        (a = e.getOffsetAt(n)),
                        [4, this._worker(s)]
                      );
                    case 1:
                      return ((u = d.sent()), e.isDisposed() ? [2] : [4, u.getCompletionsAtPosition(s.toString(), a)]);
                    case 2:
                      return (
                        (l = d.sent()),
                        !l || e.isDisposed()
                          ...
                          : ((c = l.entries.map(function (r) {
                              ...
                              if (r.replacementSpan) {
                                ...
                                l = new i.EH(c.lineNumber, c.column, d.lineNumber, d.column);
                              }
                              var p = [];
                              return (
                                -1 !==
                                  (null === (u = r.kindModifiers) || void 0 === u ? void 0 : u.indexOf("deprecated")) &&
            ...
            (t.prototype.resolveCompletionItem = function (e, n) {
              return c(this, void 0, void 0, function () {
                ...
                return d(this, function (u) {
                  switch (u.label) {
                    case 0:
                      return ((n = e), (r = n.uri), (i = n.position), (o = n.offset), [4, this._worker(r)]);
                    case 1:
                      return ((s = u.sent()), [4, s.getCompletionEntryDetails(r.toString(), o, n.label)]);
                    case 2:
                      return (
                        (a = u.sent()),
                        a
                          ? [
                              2,
                              {
                                ...
                                documentation: { value: t.createDocumentationString(a) }
                              }
                            ]
                          : [2, n]
                      );
            ...
            (t.prototype.provideSignatureHelp = function (e, n, r, i) {
              return c(this, void 0, void 0, function () {
                ...
                return d(this, function (l) {
                  switch (l.label) {
                    case 0:
                      return ((r = e.uri), (o = e.getOffsetAt(n)), [4, this._worker(r)]);
                    case 1:
                      return (
                        (s = l.sent()),
                        e.isDisposed()
                              ...
                              ((t.documentation = { value: f(e.documentation) }),
                                ...
                                e.parameters.forEach(function (n, r, i) {
                                  var o = f(n.displayParts),
                                    s = { label: o, documentation: { value: f(n.documentation) } };
                                  ((t.label += o),
                                    t.parameters.push(s),
                                    r < i.length - 1 && (t.label += f(e.separatorDisplayParts)));
                                }),
                ...
                return d(this, function (u) {
                  switch (u.label) {
                    case 0:
                      return ((n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]);
                    case 1:
                      return ((o = u.sent()), e.isDisposed() ? [2] : [4, o.getOccurrencesAtPosition(n.toString(), r)]);
                    case 2:
                      return (
                        (s = u.sent()),
                        !s || e.isDisposed()
                ...
                return d(this, function (d) {
                  switch (d.label) {
                    case 0:
                      return ((n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]);
                    case 1:
                      return ((o = d.sent()), e.isDisposed() ? [2] : [4, o.getDefinitionAtPosition(n.toString(), r)]);
                    case 2:
                      return (
                        (s = d.sent()),
                        !s || e.isDisposed()
                    ...
                    case 3:
                      ...
                      for (a = [], u = 0, l = s; u < l.length; u++)
                        ((c = l[u]),
                          ...
                          f && a.push({ uri: p, range: this._textSpanToRange(f, c.textSpan) }));
                      return [2, a];
                  }
                });
              });
                ...
                return d(this, function (d) {
                  switch (d.label) {
                    case 0:
                      return ((n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]);
                    case 1:
                      return ((o = d.sent()), e.isDisposed() ? [2] : [4, o.getReferencesAtPosition(n.toString(), r)]);
                    case 2:
                      return (
                        (s = d.sent()),
                        !s || e.isDisposed()
                  ...
                  switch (l.label) {
                    ...
                    case 1:
                      return (
                        ...
                        e.isDisposed()
                          ? [2]
                          : [4, s.getFormattingEditsForRange(r.toString(), i, o, T._convertOptions(n))]
                      );
                    case 2:
                      return (
                        (a = l.sent()),
            ...
            (t.prototype.provideOnTypeFormattingEdits = function (e, t, n, r, i) {
              return c(this, void 0, void 0, function () {
                ...
                return d(this, function (l) {
                  switch (l.label) {
                    case 0:
                      return ((i = e.uri), (o = e.getOffsetAt(t)), [4, this._worker(i)]);
                    case 1:
                      return (
                        (s = l.sent()),
                        e.isDisposed()
                          ? [2]
                          : [4, s.getFormattingEditsAfterKeystroke(i.toString(), o, n, T._convertOptions(r))]
                      );
                    case 2:
                      return (
                        (a = l.sent()),
          ...
          return (
                ...
                return d(this, function (d) {
                  switch (d.label) {
                    ...
                    case 1:
                      return (
                        (u = d.sent()),
                        e.isDisposed() ? [2] : [4, u.getCodeFixesAtPosition(r.toString(), i, o, a, s)]
                      );
                    case 2:
                      return (
                        (l = d.sent()),
                        !l || e.isDisposed()
                          ...
                          : ((c = l
                              ...
                              .map(function (t) {
                                return p._tsCodeFixActionToMonacoCodeAction(e, n, t);
                              })),
            ...
            (t.prototype._tsCodeFixActionToMonacoCodeAction = function (e, t, n) {
              for (var r = [], i = 0, o = n.changes; i < o.length; i++)
                for (var s = o[i], a = 0, u = s.textChanges; a < u.length; a++) {
                  var l = u[a];
                  r.push({ resource: e.uri, edit: { range: this._textSpanToRange(e, l.span), text: l.newText } });
                }
              var c = { title: n.description, edit: { edits: r }, diagnostics: t.markers, kind: "quickfix" };
              return c;
            }),
            t
          );
            ...
            (t.prototype.provideRenameEdits = function (e, t, n, r) {
              return c(this, void 0, void 0, function () {
                ...
                return d(this, function (d) {
                  switch (d.label) {
                    case 0:
                      return ((r = e.uri), (o = r.toString()), (s = e.getOffsetAt(t)), [4, this._worker(r)]);
                    case 1:
                      return (
                        (a = d.sent()),
                        e.isDisposed() ? [2] : [4, a.getRenameInfo(o, s, { allowRenameOfImportPath: !1 })]
                      );
                    case 2:
                      if (((u = d.sent()), !1 === u.canRename))
                        return [2, { edits: [], rejectReason: u.localizedErrorMessage }];
                      if (void 0 !== u.fileToRename) throw new Error("Renaming files is not supported.");
                      return [4, a.findRenameLocations(o, s, !1, !1, !1)];
                    case 3:
                      if (((l = d.sent()), !l || e.isDisposed())) return [2];
                      for (c = [], p = 0, f = l; p < f.length; p++) {
                        if (((h = f[p]), (g = i.SK.parse(h.fileName)), (m = i.O0.getModel(g)), !m))
                          throw new Error("Unknown URI " + g + ".");
                        c.push({ resource: g, edit: { range: this._textSpanToRange(m, h.textSpan), text: n } });
                      }
                      return [2, { edits: c }];
                  }
                });
